...
from apps.users.views import me, favorecidos_search
from apps.travel_requests.views import (
    TravelRequestViewSet,
    TravelAuthorizationViewSet,
    DestinationViewSet,
)
from apps.accountability.views import AccountabilityReportViewSet, ExpenseItemViewSet
from apps.travel_requests.views import research_activities_search
from apps.travel_requests.views import (
    TravelBeneficiaryViewSet, BudgetAllocationViewSet,
    ResearchProjectViewSet, FundingAgencyViewSet,
)
from apps.fleet.views import (
    VehicleViewSet, DriverViewSet, VehicleAssignmentViewSet,
    VehicleRequisitionViewSet,
)
from apps.travel_requests.views import (
    SponsorViewSet, ResourceLineViewSet, FlightTicketViewSet, AdvanceViewSet,
)
...
router.register(r'fleet/requisitions', VehicleRequisitionViewSet, basename='requisition')
...
urlpatterns = [
    ...
    path('api/v1/favorecidos/', favorecidos_search, name='favorecidos-search'),
    path('api/v1/atividades-pesquisa/', research_activities_search, name='atividades-pesquisa'),
